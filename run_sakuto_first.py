...
- 2026-07-15: robot.straight(400) → straight(2000, speed=1000) に変更（2m直進・最大速度）
- 2026-07-15: 両アームを最大速度(1000 deg/s)で5回転(1800度)、前進前後に追加
"""
...
async def run(hub, robot, left_wheel, right_wheel, left_lift, right_lift):
    ...
    await robot.straight(120, speed=1000)
    await robot.straight(-120, speed=1000)
    """
    ロボットの動作を記述する関数
