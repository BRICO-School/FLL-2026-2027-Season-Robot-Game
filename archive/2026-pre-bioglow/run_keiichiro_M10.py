...
【更新履歴】
- 2026-07-08: 200mm前進 → 3秒待機 → 200mm後退 の動作を実装
"""
...
async def run(hub, robot, left_wheel, right_wheel, left_lift, right_lift):
    ...
    # await robot.straight(200imeout=3000)
    # wait robot.straight(200imeout=3000)
    await robot.straight(150, timeout=3000)
    await robot.straight(-200, timeout=3000)
    """
