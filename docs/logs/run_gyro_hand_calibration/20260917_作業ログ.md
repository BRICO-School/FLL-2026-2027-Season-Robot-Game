# 作業ログ: run_gyro_hand_calibration.py
...
## 15:56 — 機体を手動で回してジャイロの補正値を測定するスクリプトを追加した

### 変更概要

機体を手動で回してジャイロの補正値を測定するスクリプトを追加した

### 差分

```diff
diff --git a/run_gyro_hand_calibration.py b/run_gyro_hand_calibration.py
new file mode 100644
index 0000000..6e3c2a7
--- /dev/null
+++ b/run_gyro_hand_calibration.py
@@ -0,0 +1,59 @@
+"""
