# 作業ログ: run_imu_calibrate_official.py
...
## 17:24 — 公式のIMU校正を実行するスクリプトを新規追加した

### 変更概要

公式のIMU校正を実行するスクリプトを新規追加した

### 差分

```diff
diff --git a/run_imu_calibrate_official.py b/run_imu_calibrate_official.py
new file mode 100644
index 0000000..ad88a76
--- /dev/null
+++ b/run_imu_calibrate_official.py
@@ -0,0 +1,21 @@
+"""
