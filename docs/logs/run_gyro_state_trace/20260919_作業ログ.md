...
## 10:44 — 旋回中のジャイロや加速度の推移を記録するスクリプトを追加した

### 変更概要

旋回中のジャイロや加速度の推移を記録するスクリプトを追加した

### 差分

```diff
diff --git a/run_gyro_state_trace.py b/run_gyro_state_trace.py
new file mode 100644
index 0000000..6d13f4f
--- /dev/null
+++ b/run_gyro_state_trace.py
@@ -0,0 +1,118 @@
+"""
